...
const Sidebar = ({ sidebarOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: '/admin/accounts',
      icon: 'image',
      imageSrc: '/AdminAsset/default-avatar-profile-icon-social-media-user-image-gray-avatar-icon-blank-profile-silhouette-illustration-vector-removebg-preview.png'
    },
    {
      name: 'Book Manage',
      path: '/admin/books',
    ...
    },
    {
      ...
      path: '/admin/coupons',
      icon: 'svg',
      svg: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.99 1.99 0 013 12V7a4 4 0 014-4z"></path>
    },
    {
      name: 'Service Manage',
      path: '/admin/services',
    ...
    },
    {
      ...
      icon: 'svg',
      svg: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
    }
  ]
                ...
                {item.icon === 'image' ? (
                  ...
                  <svg 
                    className={`mr-3 h-5 w-5 transition-colors duration-200 ${
                      isActive(item.path) ? 'text-red-500' : 'text-gray-400 group-hover:text-red-500'
                    }`}
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
