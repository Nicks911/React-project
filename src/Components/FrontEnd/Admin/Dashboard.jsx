            ...
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-white text-opacity-90 truncate">Active Users</dt>
                    <dd className="text-3xl font-bold text-white">1,247</dd>
                    <dd className="text-xs text-white text-opacity-80 mt-1">↑ 12% from last month</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-200">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-white text-opacity-90 truncate">Active Coupons</dt>
                    <dd className="text-3xl font-bold text-white">52</dd>
                    <dd className="text-xs text-white text-opacity-80 mt-1">12 expiring soon</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-200">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-white text-opacity-90 truncate">Revenue (Monthly)</dt>
                    <dd className="text-3xl font-bold text-white">Rp 20.1M</dd>
                    <dd className="text-xs text-white text-opacity-80 mt-1">↑ 8.5% from last month</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-200">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-white text-opacity-90 truncate">Revenue (Weekly)</dt>
                    <dd className="text-3xl font-bold text-white">Rp 5.3M</dd>
                    <dd className="text-xs text-white text-opacity-80 mt-1">Current week (Week 4)</dd>
                  </dl>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">Revenue vs Discount vs Net Revenue (2024)</p>
            </div>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={monthlyRevenueData}>
                ...
                />
                <Legend />
                <Line type="monotone" dataKey="revenue" stroke="#8B5CF6" strokeWidth={2} name="Gross Revenue" />
                <Line type="monotone" dataKey="discount" stroke="#EF4444" strokeWidth={2} name="Coupon Discount" />
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">October 2024 - Weekly Performance</p>
            </div>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">Distribution by service type</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 lg:col-span-2">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">Detailed breakdown of current month</p>
            </div>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                <div>
                  <p className="text-sm text-gray-600">Gross Revenue (October)</p>
                  <p className="text-2xl font-bold text-purple-600">Rp 22,400,000</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">- Rp 2,240,000</p>
                </div>
                <div className="text-right">
              ...
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border-2 border-green-200">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">Rp 20,160,000</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-gray-600">Avg per Booking</p>
                  <p className="text-xl font-semibold text-gray-900">Rp 81,619</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div className="p-3 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-lg font-bold text-blue-600">Haircut (35%)</p>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          <div className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-blue-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-500 uppercase">Pending Bookings</p>
