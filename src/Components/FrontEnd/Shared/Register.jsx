        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10">
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-semibold rounded-lg text-white bg-red-300 hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-300 transition-all duration-300 transform hover:scale-[1.02] shadow-lg"
              >
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/login" className="font-medium text-red-400 hover:text-red-500 transition duration-150 ease-in-out">
                  Sign in here
                </Link>
              </p>
            </div>
