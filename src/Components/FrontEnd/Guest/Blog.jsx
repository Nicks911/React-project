const Blog = () => {
  const blogPosts = [
    {
      ...
      excerpt: "Discover the essential tips and tricks to maintain healthy, shiny, and beautiful hair all year round.",
    ...
    },
    {
      ...
      excerpt: "Explore the hottest hair color trends that are taking the beauty world by storm this season.",
    ...
    },
    {
      ...
      excerpt: "Learn why regular hair spa treatments are essential for maintaining healthy and vibrant hair.",
    ...
    },
    {
      ...
      excerpt: "A comprehensive guide to finding the perfect haircut that complements your unique face shape.",
    ...
    },
    {
      ...
      excerpt: "Discover the power of natural ingredients and how they can transform your hair care routine.",
    ...
    },
    {
      ...
      excerpt: "Get inspired by these stunning bridal hair styles perfect for your special day.",
  ...
  const categories = ["All", "Hair Care", "Trends", "Treatment", "Style Guide", "Natural Care", "Bridal"]
